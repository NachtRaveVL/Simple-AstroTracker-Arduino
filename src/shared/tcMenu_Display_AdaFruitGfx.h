...
template <class T> class AdafruitCanvasDrawable2bpp;
...
private:
    ...
    AdafruitCanvasDrawable2bpp<T>* canvasDrawable;
protected:
    int spriteHeight = 0;
public:
 ...
 */
template <class T>
class AdafruitCanvasDrawable2bpp : public AdafruitDrawable<T> {
private:
    AdafruitDrawable<T>* root;
    TcGFXcanvas2* canvas;
    Coord sizeMax;
    Coord sizeCurrent;
    Coord where;
    color_t palette[4];
public:
    AdafruitCanvasDrawable2bpp(AdafruitDrawable<T>* root,  int width, int height);
