...
#include <Astruino.h>
#if defined(ASTRO_USE_GUI) && (defined(ARDUINO_ARCH_MBED) || defined(ARDUINO_ARCH_STM32))
#include "AstruinoUI.h"
#if (defined(ASTRO_UI_ENABLE_STCHROMA_LDTC) || defined(ASTRO_UI_ENABLE_BSP_TOUCH))
