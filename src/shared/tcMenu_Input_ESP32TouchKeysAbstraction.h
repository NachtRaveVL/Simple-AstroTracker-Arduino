/*  Astruino: Simple automation controller for DIY astronomical tracking systems.
    ...
    tcMenu ESP32 Touch Keys
*/

#include <Astruino.h>
#if defined(ASTRO_USE_GUI) && defined(ESP32)
...
/**
 * An IoAbstraction that can work with the touch key sensors on ESP32 boards using the underlying functions.
 */
