...
struct AstroCalibrationData : public AstroData {
    ...
    inline AstroSingleMeasurement inverseTransform(AstroSingleMeasurement measurement) { return AstroSingleMeasurement(inverseTransform(measurement.value), calibrationUnits, measurement.timestamp, measurement.frame); }
