...
enum Astro_Autosave : signed char {
    Astro_Autosave_EnabledToSDCardJson,                     // Autosave to SD card in Json
    Astro_Autosave_EnabledToSDCardRaw,                      // Autosave to SD card in binary
    Astro_Autosave_EnabledToEEPROMJson,                     // Autosave to EEPROM in Json
    Astro_Autosave_EnabledToEEPROMRaw,                      // Autosave to EEPROM in binary
    Astro_Autosave_EnabledToWiFiStorageJson,                // Autosave to WiFiStorage in Json
    Astro_Autosave_EnabledToWiFiStorageRaw,                 // Autosave to WiFiStorage in binary
    Astro_Autosave_Disabled = -1                            // Autosave disabled
};

// User System Setup Data
// id: ASYS. User system setup data.
struct AstroSystemData : public AstroData {
    Astro_SystemMode systemMode;                            // System type mode
    ...
    AstroSchedulerSubData scheduler;                        // Scheduler subdata
    AstroLoggerSubData logger;                              // Logger subdata
    AstroPublisherSubData publisher;                        // Publisher subdata
...
struct AstroCalibrationData : public AstroData {
    ...
    AstroCalibrationData(AstroIdentity ownerId,
                         Astro_UnitsType calibrationUnits = Astro_UnitsType_Undefined);
    ...
    inline void transform(float *valueInOut, Astro_UnitsType *unitsOut = nullptr) const { *valueInOut = transform(*valueInOut);
    ...
    inline AstroSingleMeasurement transform(AstroSingleMeasurement measurement) { return AstroSingleMeasurement(transform(measurement.value), calibrationUnits, measurement.timestamp, measurement.frame); }
    ...
    inline void inverseTransform(float *valueInOut, Astro_UnitsType *unitsOut = nullptr) const { *valueInOut = inverseTransform(*valueInOut);
    ...
    inline AstroSingleMeasurement inverseTransform(AstroSingleMeasurement measurement) { return AstroSingleMeasurement(inverseTransform(measurement.value), Astro_UnitsType_Raw_1, measurement.timestamp, measurement.frame); }
